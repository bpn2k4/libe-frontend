...
const utilities = {
  ...
  '.border-primary': { '@apply border-rgb-230 dark:border-rgb-60': 0 },
  ...
  '.shadow-primary': { '@apply shadow-[0_1px_4px_0_rgba(0,0,0,0.2)] dark:shadow-[0_1px_4px_0_rgba(0,0,0,0.2)]': 0 },
  '.bg-table': { '@apply bg-rgb-255 dark:bg-rgb-0': 0 },
}
