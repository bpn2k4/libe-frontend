...
export const AreaField = ({
  ...
  return (
    <div className={twMerge('w-full text-sm relative group', className)}>
      <textarea
        className={twMerge(
          'outline-none resize-none w-full border pl-2 border-base-219 dark:border-base-54 rounded bg-transparent transition-all hover:border-base-115 dark:hover:border-base-115 hover:ring-[0.5px] hover:ring-base-115 dark:hover:ring-base-115 min-h-24 pt-2.5 pb-3 scroll-p-10',
      ...
      {label && (
        <label
          htmlFor={id}
          className={twMerge(
            'absolute cursor-text top-2.5 left-2 transition-all bg-main px-1 opacity-75 duration-300',
