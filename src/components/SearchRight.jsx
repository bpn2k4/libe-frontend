...
export const SearchRight = () => {
  ...
  return (
    <div className='MenuLeft text-primary'>
      {show && <div className='fixed z-[10] offset-0 bg-black/50' onClick={() => setShow(false)} />}
      <div className={twMerge(
        'fixed z-[11] text-base top-0 right-0 bottom-0 w-full md:max-w-[400px] bg-primary origin-right transition-transform duration-300',
        ...
        <div className={twMerge(
          ...
          <div className='relative'>
            <input
              className={twMerge(
                'my-2 w-full h-10 outline-none border border-primary bg-transparent rounded pl-2',
            ...
            <button className='absolute top-1/2 -translate-y-1/2 right-1 w-10 h-8 border rounded center border-primary active:scale-95 active:opacity-80'>
          ...
          <div>
            <Link
              className='w-full h-11 border border-primary rounded font-semibold hover:bg-gray-80 hover:dark:bg-gray-750 center active:scale-[0.98] transition-transform'
              to='/search'
              onClick={() => setShow(false)}>
              Xem them ket qua
            </Link>
