...
export const Pagination = ({ className, total = 1, cx, page = 1, onChange }) => {
  ...
  return (
    <div className={twMerge(
      ...
      <button
        onClick={() => _onChange(1)}
        className='h-9 w-9 center rounded border border-main hover:bg-main-reverse hover:text-main-reverse active:scale-95 transition-all'>
      ...
      <button className='h-9 w-9 center rounded border border-main bg-main-reverse text-main-reverse active:scale-95 transition-all'>
        {page}
      </button>
      {page < total &&
        <button
